        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VipUser = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    answer_amount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    time_to_send = table.Column<TimeOnly>(type: "time", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_reports_payments_transaction_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_word_quizzes_quiz_id",
                table: "word_quizzes",
                column: "quiz_id");

            migrationBuilder.CreateIndex(
                name: "IX_word_quizzes_word_id",
                table: "word_quizzes",
                column: "word_id");
